...
class StructsFileUpload {
     ...
     * @param {module:model/StructsFileUpload} obj Optional instance to populate.
     * @return {module:model/StructsFileUpload} The populated <code>StructsFileUpload</code> instance.
     */
