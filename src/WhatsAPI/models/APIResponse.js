 ...
 * @module WhatsAPI/models/APIResponse
 * @version 1.0.0
 */
class APIResponse {
    /**
     * Constructs a new <code>APIResponse</code>.
     * @alias module:WhatsAPI/models/APIResponse
     */
    constructor() { 
     ...
     * @param {module:WhatsAPI/models/APIResponse} obj Optional instance to populate.
     * @return {module:WhatsAPI/models/APIResponse} The populated <code>APIResponse</code> instance.
     */
