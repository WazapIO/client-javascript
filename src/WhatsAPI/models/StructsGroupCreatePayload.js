 ...
 * @module WhatsAPI/models/StructsGroupCreatePayload
 * @version 1.0.0
 */
class StructsGroupCreatePayload {
    /**
     * Constructs a new <code>StructsGroupCreatePayload</code>.
     * @alias module:WhatsAPI/models/StructsGroupCreatePayload
     */
    constructor() { 
     ...
     * @param {module:WhatsAPI/models/StructsGroupCreatePayload} obj Optional instance to populate.
     * @return {module:WhatsAPI/models/StructsGroupCreatePayload} The populated <code>StructsGroupCreatePayload</code> instance.
     */
