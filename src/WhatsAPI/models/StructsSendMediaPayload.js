 ...
 * @module WhatsAPI/models/StructsSendMediaPayload
 * @version 1.0.0
 */
class StructsSendMediaPayload {
    /**
     * Constructs a new <code>StructsSendMediaPayload</code>.
     * @alias module:WhatsAPI/models/StructsSendMediaPayload
     * @param mediaData {module:WhatsAPI/models/StructsFileUpload} 
     ...
     * @param {module:WhatsAPI/models/StructsSendMediaPayload} obj Optional instance to populate.
     * @return {module:WhatsAPI/models/StructsSendMediaPayload} The populated <code>StructsSendMediaPayload</code> instance.
     */
