 ...
 * @module WhatsAPI/models/StructsTextMessage
 * @version 1.0.0
 */
class StructsTextMessage {
    /**
     * Constructs a new <code>StructsTextMessage</code>.
     * @alias module:WhatsAPI/models/StructsTextMessage
     * @param text {String} 
     * @param to {String} 
     */
    constructor(text, to) { 
     ...
     * @param {module:WhatsAPI/models/StructsTextMessage} obj Optional instance to populate.
     * @return {module:WhatsAPI/models/StructsTextMessage} The populated <code>StructsTextMessage</code> instance.
     */
