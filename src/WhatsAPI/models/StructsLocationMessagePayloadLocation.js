 ...
 * @module WhatsAPI/models/StructsLocationMessagePayloadLocation
 * @version 1.0.0
 */
class StructsLocationMessagePayloadLocation {
    /**
     * Constructs a new <code>StructsLocationMessagePayloadLocation</code>.
     * @alias module:WhatsAPI/models/StructsLocationMessagePayloadLocation
     ...
     * @param {module:WhatsAPI/models/StructsLocationMessagePayloadLocation} obj Optional instance to populate.
     * @return {module:WhatsAPI/models/StructsLocationMessagePayloadLocation} The populated <code>StructsLocationMessagePayloadLocation</code> instance.
     */
