...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhatsApiGo.StructsSendMediaPayload();
  });
  ...
  describe('StructsSendMediaPayload', function() {
    it('should create an instance of StructsSendMediaPayload', function() {
      ...
      //var instance = new WhatsApiGo.StructsSendMediaPayload();
      //expect(instance).to.be.a(WhatsApiGo.StructsSendMediaPayload);
    });
