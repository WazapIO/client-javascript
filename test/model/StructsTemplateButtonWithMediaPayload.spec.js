...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhatsApiGo.StructsTemplateButtonWithMediaPayload();
  });
  ...
  describe('StructsTemplateButtonWithMediaPayload', function() {
    it('should create an instance of StructsTemplateButtonWithMediaPayload', function() {
      ...
      //var instance = new WhatsApiGo.StructsTemplateButtonWithMediaPayload();
      //expect(instance).to.be.a(WhatsApiGo.StructsTemplateButtonWithMediaPayload);
    });
