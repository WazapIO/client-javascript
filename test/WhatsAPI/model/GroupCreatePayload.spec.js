...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhatsApi.GroupCreatePayload();
  });
  ...
  describe('GroupCreatePayload', function() {
    it('should create an instance of GroupCreatePayload', function() {
      // uncomment below and update the code to test GroupCreatePayload
      //var instance = new WhatsApi.GroupCreatePayload();
      //expect(instance).to.be.a(WhatsApi.GroupCreatePayload);
    });
