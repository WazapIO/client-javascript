...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhatsApi.TemplateButtonWithMediaPayload();
  });
  ...
  describe('TemplateButtonWithMediaPayload', function() {
    it('should create an instance of TemplateButtonWithMediaPayload', function() {
      // uncomment below and update the code to test TemplateButtonWithMediaPayload
      //var instance = new WhatsApi.TemplateButtonWithMediaPayload();
      //expect(instance).to.be.a(WhatsApi.TemplateButtonWithMediaPayload);
    });
