...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhatsApi.ListItem();
  });
  ...
  describe('ListItem', function() {
    it('should create an instance of ListItem', function() {
      // uncomment below and update the code to test ListItem
      //var instance = new WhatsApi.ListItem();
      //expect(instance).to.be.a(WhatsApi.ListItem);
    });
