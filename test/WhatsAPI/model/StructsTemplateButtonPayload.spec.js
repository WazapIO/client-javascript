...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhatsApi.StructsTemplateButtonPayload();
  });
  ...
  describe('StructsTemplateButtonPayload', function() {
    it('should create an instance of StructsTemplateButtonPayload', function() {
      ...
      //var instance = new WhatsApi.StructsTemplateButtonPayload();
      //expect(instance).to.be.a(WhatsApi.StructsTemplateButtonPayload);
    });
