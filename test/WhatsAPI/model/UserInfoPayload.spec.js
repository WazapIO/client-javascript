...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhatsApi.UserInfoPayload();
  });
  ...
  describe('UserInfoPayload', function() {
    it('should create an instance of UserInfoPayload', function() {
      // uncomment below and update the code to test UserInfoPayload
      //var instance = new WhatsApi.UserInfoPayload();
      //expect(instance).to.be.a(WhatsApi.UserInfoPayload);
    });
