...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhatsApi.StructsGroupCreatePayload();
  });
  ...
  describe('StructsGroupCreatePayload', function() {
    it('should create an instance of StructsGroupCreatePayload', function() {
      ...
      //var instance = new WhatsApi.StructsGroupCreatePayload();
      //expect(instance).to.be.a(WhatsApi.StructsGroupCreatePayload);
    });
